...
export const pages: PageContent[] = [
  ...
  },
  {
    ...
    text: "Cada instante a tu lado ha sido un gran regalo y hoy quiero regalarte esta carta en una web app que programé pensando en ti y en nosotros. Expresar lo que siento por ti de una manera diferente y a mi estilo.\nEspero que disfrutes cada página tanto como yo disfruté creándola para ti...",
    effect: 'sparkles',
  },
  /// ... more pages here ...  
  {
    ...
    text: "Te conocí en lo que era un refugio para mi: la academia.\nY un día llegaste tú. Bailando contigo todo fluía desde el primer paso, y cada clase me daba más ganas de que llegara la siguiente. Tu sonrisa, tu belleza y tu olor me ponían nervioso (hasta la fecha). Cada vez quería más conocerte fuera del ambito del baile.",
    effect: 'petals',
  },
  {
    id: 5,
  ...
  },
  {
    ...
    text: 'Desde ese día me dediqué a enamorarte. Y tú, quizás con miedo o sin saberlo, hiciste lo mismo conmigo. Te mostré mi lado más vulnerable, y tú me mostraste el tuyo. Entre más te conocía, más te admiraba, más me estaba enamorando de ti y de tu hermosa sonrisa.',
    effect: 'sparkles',
  },
  {
    id: 8,
    ...
    text: 'Eres una mujer admirable y excepcional, con un enorme corazón, ambiciosa, con una claridad sobre lo que quieres en la vida que pocas personas tienen. Eres mucho más inteligente que yo. Y eso, en lugar de intimidarme, lo atesoro como algo que quiero cuidar para siempre.',
    effect: 'petals',
  },
  {
    id: 9,
